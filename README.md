...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-vlw9pbq.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-vlw9pbq.containers.anotherwebservice.com/
...
```
git clone git@github.com:chrisjsimpson/container-vlw9pbq.git
cd container-vlw9pbq
```
...
```
docker attach container-vlw9pbq
```
